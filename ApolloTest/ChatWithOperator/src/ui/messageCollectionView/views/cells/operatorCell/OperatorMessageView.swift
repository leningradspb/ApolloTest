 ...
 */
class OperatorMessageView: UIView {
    ...
    override func awakeFromNib() {
        ...
        backgroundColor = ChatColors.bgInfo
    ...
    override func layoutIfNeeded() {
        ...
        contentMessageView.frame.origin = CGPoint(x: contentEdge.left, y: contentEdge.top)
        contentMessageView.frame.size.width = frame.size.width - (contentEdge.left + contentEdge.right)
        contentMessageView.layoutIfNeeded()
        
        frame.size.height = contentMessageView.frame.size.height + (contentEdge.top + contentEdge.bottom)
        frame.size.width = contentMessageView.frame.size.width + (contentEdge.left + contentEdge.right)
    }
